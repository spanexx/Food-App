...
var Food_models_1 = require("../Models/Food.models");
...
router.get("/seed", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Food_models_1.FoodModel.countDocuments()];
            case 1:
                foodsCount = _a.sent();
                if (foodsCount > 0) {
                ...
                return [4 /*yield*/, Food_models_1.FoodModel.create(data_1.sample_foods)];
            case 2:
                _a.sent();
...
router.get("/", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Food_models_1.FoodModel.find()];
            case 1:
                foods = _a.sent();
                res.send(foods);
                return [2 /*return*/];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, Food_models_1.FoodModel.find({ name: { $regex: searchRegex } })];
            case 1:
                foods = _a.sent();
                res.send(foods);
                return [2 /*return*/];
...
router.get("/tags", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, Food_models_1.FoodModel.aggregate([
                    {
                        $unwind: '$tags'
                    },
                    {
            ...
            case 1:
                ...
                return [4 /*yield*/, Food_models_1.FoodModel.countDocuments()];
            case 2:
...
router.get("/tag/:tagName", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Food_models_1.FoodModel.find({ tags: req.params.tagName })];
            case 1:
                foods = _a.sent();
                res.send(foods);
                return [2 /*return*/];
...
router.get("/:foodId", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Food_models_1.FoodModel.findById(req.params.foodId)];
            case 1:
                food = _a.sent();
                res.send(food);
                return [2 /*return*/];
